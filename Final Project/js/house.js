...
function addLighting() {
  livingroom_light = new THREE.PointLight(new THREE.Color(1,1,1));	
  //livingroom_light.position.set(5, 20, 3);
  //scene.add(livingroom_light);

  bedroom_light = new THREE.PointLight(new THREE.Color(1,1,1));
  //bedroom_light.position.set(-10, 20, 0);
  //scene.add(bedroom_light);

  bathroom_light = new THREE.PointLight(new THREE.Color(1,1,1));
